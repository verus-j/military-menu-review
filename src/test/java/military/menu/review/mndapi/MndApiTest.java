...
class MndApiTest {
	...
	public void shouldGetTotalMenu() {
		...
		assertThat(menuList, is(MenuList.asList(Menu.of("쇠고기무국", 45.12), Menu.of("김치찌개", 70.45), Menu.of("돼지고기고추장찌개", 105.67),
